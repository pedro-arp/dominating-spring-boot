...
class BrasilApiControllerIT extends IntegrationTestContainers {
    ...
    void findCep_ReturnsNotFoundException_WhenNotFound() throws Exception {
        var cep = "00000-404";
        var expectedResponse = fileUtils.readResourceFile("brasil-api/expected-get-cep-error-response-404.json");
